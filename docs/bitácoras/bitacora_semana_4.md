...
Se realizaron los procesos finales de conexión y prueba para la cortina industrial, además se implementaron los principios básicos de HMI (interfaz humano-máquina) para mejorar el funcionamiento de la cortina. 
